                        ...
                        <div class="border">
                            <div class="container" style="padding: 15px;" id="invoice">
                                <div class="header" style="text-align: center;">
                                    <h3>PERSETUJUAN DAN PERMOHONAN SIDANG TESIS</h3>
                                </div>
                                <br>
                                <div class="name">
                                ...
                                <div class="tabel-mk signature-container">
                                    <span class="signature">Makassar, <?= $mhs1['tanggal_surat']; ?></span><br>
                                    <br>
                                    <br>
                                </div>
                                <br>
                                    ...
                                    <table class="text-center">
                                        <tr>
                                            <td style="vertical-align: bottom;">
                                                <img width="100px" src="<?= base_url('assets/File/Tanda_tangan_mhs/') . $mhs1['tanda_tanga_digital_mhs_1']; ?>">
                                            </td>
